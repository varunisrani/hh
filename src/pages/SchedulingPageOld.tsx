...
import { Plus, Share2, Download, Calendar, Clock, Users, DollarSign, AlertTriangle, MapPin, Wand2, Brain, CheckCircle, Loader2 } from 'lucide-react';
...
export const SchedulingPage = () => {
  ...
  const [activeView, setActiveView] = useState<'overview' | 'schedule' | 'cast' | 'locations'>('overview');
